...
INSERT INTO `pelikula` VALUES (1,'Avatar','Zientzia fikziozko pelikula epikoa',100,0),(2,'Inception','Ametsen barruan gertatzen den thriller psikologikoa',80,0),(3,'Interstellar','Espazioan zehar bidaia gizateriaren etorkizuna salbatzeko',120,0),(4,'Titanic','Drama erromantikoa eta historikoa',150,0),(5,'The Dark Knight','Batmanen istorio iluna Jokerrekin',90,0),(6,'Frozen','Animaziozko pelikula familiarra',60,0),(7,'Matrix','Errealitate birtualaren inguruko zientzia fikzioa',75,0),(8,'Gladiator','Erromatar inperioan kokatutako akzio drama',110,1);
...
-- Dump completed on 2026-02-16 13:15:46
